...
<head>
    ...
    <style>
        ...
        body {background:url(${ctx.contextPath}/images/index.jpg) 0% 0% / cover no-repeat;position:static;font-size:12px;}
        ...
        .login-shadow{ -moz-box-shadow: 2px 2px 10px #909090;/*firefox*/-webkit-box-shadow: 2px 2px 10px #909090;opacity: 0.7;border-radius: 12px}
...
<body>
<div class="main-body login-shadow">
        ...
        <form class="layui-form login-bottom" action="">
            <div class="center">
                ...
                <div class="item">
                    ...
                    <span class="bind-password icon icon-4" onclick="showPassword()"></span>
                </div>
           ...
           <div class="tip">
               ...
               <label class="login-tip" for="rememberMe" id="clickRemember">保持登录</label>
...
<script>
    function showPassword(){
        ...
        let str = input_password.getAttribute('type')
        input_password.setAttribute('type',str === 'password' ? 'text' : 'password')
    }
</script>
</body>
</html>